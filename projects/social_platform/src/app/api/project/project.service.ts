...
import { projectNewAdditionalProgramVields } from "projects/social_platform/src/app/domain/program/partner-program-fields.model";
import { Project, ProjectCount, ProjectStep } from "../../domain/project/project.model";
