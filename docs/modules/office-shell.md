...
| Что                                                                                                                     | Где                                                                 | Заметка                                                             |
| ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------- | ------------------------------------------------------------------- |
| `NotificationService.hasNotifications` инвертированная семантика — считает прочитанные, а JSDoc говорит «непрочитанные» | `ui/services/notification/notification.service.ts:hasNotifications` | Поправить фильтр на `!notification.readAt` или переименовать.       |
